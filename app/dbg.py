...
def _dbgSearchTiles(definition, lng0, lat0, lng1, lat1):
    ...
    tiles = getTilesNames(definition, lng0, lat0, lng1, lat1, True)
    count = len(tiles)
    i = 1
    for tile in tiles:
...
#print(json.dumps(_debugReadgltf(os.path.join(BASE_DIR, f"merge.glb")), indent=2))